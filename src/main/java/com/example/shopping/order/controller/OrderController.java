...
public class OrderController {
    ...
    public ResponseEntity<RestResult<Object>> saveOrder(@RequestBody OrderRequest orderRequest, @PathVariable("productSeq") Long productSeq, @PathVariable("memberSeq") Long memberSeq) {
        return orderService.saveOrder(orderRequest, productSeq, memberSeq);
    }
